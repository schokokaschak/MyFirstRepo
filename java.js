let statistic = document.querySelector(".container_h3")
...
for (let i = 0; i < cookies.length; i += 1){
    if (cookies[i].split('=')[0] == ' highscore_ultimate_game_1234') {
...
if (cookie) {
    ...
    statistic.innerHTML = `<h3>Last time you gave ${data[0]} correct answers out of ${data[1]}. 
    Accuracy is ${Math.round(data[0] * 100 / data[1])}%.</h3>`
}
...
start_button.addEventListener('click', function() {
    ...
    setTimeout(function() {
    let new_cookie = `highscore_ultimate_game_1234=${correct_answers}/${total_answers_given};max-age:1000000000`
